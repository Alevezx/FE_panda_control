...
def callback(data):
    ...
    file_path = '/home/panda/Documents/Data_Collision_Avoidance/rotation_matrix.txt'
...
def listener():
    ...
    try:
        with open("/home/panda/Documents/Data_Collision_Avoidance/marker_pos.txt", 'r') as file:
