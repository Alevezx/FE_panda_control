...
def callback(data):
    ...
    #file_path = '/home/lab/donaldo_ws/progetto_tesi_magistrale/applicazione_controllo_ammettenza/traiettoria_rettilinea_setup_completo/rotation_matrix.txt'
    file_path = '/home/lab/donaldo_ws/progetto_tesi_magistrale/implementazione_dynamic_safety_zones/01_versione_parallela/rotation_matrix.txt'
...
def listener():
    ...
    try:
        #with open("/home/lab/donaldo_ws/progetto_tesi_magistrale/applicazione_controllo_ammettenza/traiettoria_rettilinea_setup_completo/marker_pos.txt", 'r') as file:
        with open("/home/lab/donaldo_ws/progetto_tesi_magistrale/implementazione_dynamic_safety_zones/01_versione_parallela/marker_pos.txt", 'r') as file:
