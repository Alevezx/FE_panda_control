...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lcustom_franka_state_controller;/usr/lib/libfranka.so.0.8.0".split(';') if "-lcustom_franka_state_controller;/usr/lib/libfranka.so.0.8.0" != "" else []
PROJECT_NAME = "franka_interface"
PROJECT_SPACE_DIR = "/home/lab/donaldo_ws/workspace_calibration_ros/catkin_ws/install"
