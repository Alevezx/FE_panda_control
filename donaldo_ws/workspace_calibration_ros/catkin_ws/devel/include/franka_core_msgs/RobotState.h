  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::franka_core_msgs::RobotState_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.O_dP_EE.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.O_dP_EE[i]);
    }
    if (v.O_dP_EE.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.coriolis.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.coriolis[i]);
    }
    if (v.coriolis.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.mass_matrix.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.mass_matrix[i]);
    }
    if (v.mass_matrix.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.O_Jac_EE.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.O_Jac_EE[i]);
    }
    if (v.O_Jac_EE.empty() || true)
      s << "]";
    if (true || !indent.empty())
