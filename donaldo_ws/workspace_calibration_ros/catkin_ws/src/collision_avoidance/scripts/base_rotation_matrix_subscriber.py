...
def listener():
    ...
    file = open("/home/lab/donaldo_ws/progetto_tesi_magistrale/applicazione_controllo_ammettenza/05_pick_and_place_v2/marker_pos.txt", 'r')
    ...
    while True: 
        ...
        if not arg == []:         
            ...
            file = open('/home/lab/donaldo_ws/progetto_tesi_magistrale/applicazione_controllo_ammettenza/05_pick_and_place_v2/rotation_matrix_test.txt', 'w')
